...
mongoose
  .connect(
    `mongodb+srv://nimishgoel3:dwfzvTezPIEifqmS@cluster0.c3epvqs.mongodb.net/?retryWrites=true&w=majority`,
    {
...
app.get("/api/weather/:city", async (req, res) => {
  try {
    const { data } = await axios.get(
      `http://api.openweathermap.org/data/2.5/weather?q=${req.params.city}&appid=${WEATHER_API_KEY}`
    );
